...
pub struct Window<'a, Model: Send + 'static, Message: 'static> {
    ...
    // root component
    root_component: Component<Model, Message, Message>, // todo: consider use deferent type for ui event output and message input
    ...
    for Window<'_, Model, Message>
{
    fn resumed(&mut self, event_loop: &winit::event_loop::ActiveEventLoop) {
        ...
        let gpu_state = tokio::spawn(gpu_state::GpuState::new(
